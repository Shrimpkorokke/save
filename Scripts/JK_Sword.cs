    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if(other.tag == "Monster" || other.tag == "Monster_Attack")
        {
            ...
            if(this.tag == "Player_SDash")
            {
                ...
                HSK_MeleeEnemy01.SingleTonMeleeEnemy01.hp = HSK_MeleeEnemy01.SingleTonMeleeEnemy01.hp - damage;
                other.GetComponent<HSK_MeleeEnemy01>().HpBarDown();
                //other.transform.position = other.transform.position + JK_Player.instance.dir * 100 * Time.deltaTime;
                other.transform.position = Vector3.Lerp(other.transform.position, other.transform.position + JK_Player.instance.dir * 100, Time.deltaTime * 0.5f);
